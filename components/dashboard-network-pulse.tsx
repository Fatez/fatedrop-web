  ...
  return (
    <div className="fd-pulse-layout">
      <div className="fd-pulse-visual">
        ...
        <div className="fd-pulse-map-caption fd-pulse-explain"><b>UK NETWORK FOOTPRINT</b><span>Schematic geography · node density follows the active-retailer count, not exact branch locations.</span></div>
      </div>

      <div className="fd-pulse-intelligence">
        <div className="fd-pulse-intro"><span>FATEDROP NETWORK INTELLIGENCE</span><strong>A real network should look like one.</strong><p>Retailers, Products and Signals are surfaced from canonical network metrics. No decorative counts. No browser-made business truth.</p></div>
