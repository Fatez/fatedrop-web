  ...
  return (
    <div className="fd-pulse-layout">
      ...
      <div className="fd-pulse-explain">
        ...
        <span>See the size and activity of the FateDrop network in real time — active retailers, tracked products and live signal activity. The map is illustrative; the numbers come from real network data.</span>
      </div>
      <style>{`
