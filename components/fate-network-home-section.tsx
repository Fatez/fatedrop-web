    ...
    <section className="content-section section-shell split-section" aria-labelledby="fate-network-home-title">
      ...
      <div className="insight-panel retailer-network-panel fd-network-intel">
        ...
        <style>{`
          ...
          .fd-network-confidence{margin:12px 24px 0;padding:12px 14px;border:1px solid rgba(220,203,189,.06);border-radius:11px;background:#0b0e12}.fd-network-confidence>small{display:block;margin-bottom:9px;color:#7d706b;font-size:7px;font-weight:900;letter-spacing:.11em}.fd-network-confidence>div{display:grid;grid-template-columns:auto auto auto auto auto auto auto;gap:6px;align-items:center}.fd-network-confidence span{padding:6px 7px;border:1px solid rgba(220,203,189,.07);border-radius:999px;font-size:7px;font-weight:850;text-align:center}.fd-network-confidence span:nth-of-type(1){color:#D2B66F;border-color:rgba(210,182,111,.34);background:rgba(210,182,111,.055)}.fd-network-confidence span:nth-of-type(2){color:#D9CDBB;border-color:rgba(217,205,187,.27);background:rgba(217,205,187,.045)}.fd-network-confidence span:nth-of-type(3){color:#7C6EFF;border-color:rgba(124,110,255,.38);background:rgba(124,110,255,.07)}.fd-network-confidence span:nth-of-type(4){color:#EF4D5A;border-color:rgba(239,77,90,.35);background:rgba(239,77,90,.06)}.fd-network-confidence i{color:#5d5559;font-size:8px;font-style:normal}
