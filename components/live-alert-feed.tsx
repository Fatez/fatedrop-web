...
const kindMeta: Record<SignalKind, { label: string; glyph: string; context?: string }> = {
  ...
  catalogue_price_change: { label: "WHISPER", glyph: "W", context: "catalogue price metadata changed" },
  inventory_quantity_change: { label: "WHISPER", glyph: "W", context: "inventory metadata changed" },
  product_evidence_change: { label: "WHISPER", glyph: "W", context: "product evidence changed" },
  stock_watch_refresh: { label: "WHISPER", glyph: "W", context: "unresolved stock watch remains active" },
