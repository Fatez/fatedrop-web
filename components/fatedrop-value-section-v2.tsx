...
export function FateDropValueSectionV2() {
  return <section className="fdv2 section-shell" id="what-fatedrop-does" aria-labelledby="fdv2-title">
    ...
    <div className="fdv2-grid">
      ...
      <article>
        <div className="fdv2-number"><span>04</span><small>FATE NETWORK</small></div>
        <h3>One network. More places to buy.</h3>
        <p>Fate Network gives the buying tools one connected view of major retailers, specialist TCG stores and independent businesses. If an evidence-backed offer is useful, collectors can discover it and continue to that retailer&apos;s own website and checkout.</p>
        <div className="fdv2-flow"><span><small>RETAILERS</small><b>Connected supply</b></span><i>→</i><span><small>FATE NETWORK</small><b>Evidence + intelligence</b></span><i>→</i><span className="answer"><small>COLLECTOR</small><b>Buy direct from store</b></span></div>
        <small className="fdv2-neutral">Paid retailer tools can improve business capability. They cannot buy a better FateFind verdict, artificial trust, alert priority or RRP treatment.</small>
      </article>
    </div>

    <footer className="fdv2-footer"><div><small>ONE BUYING JOURNEY</small><strong>Search → FateFind → FateMatch → retailer.</strong></div><div><Link className="button button-primary" href="/demo">Try the interactive demo <span>↗</span></Link><Link className="button button-secondary" href="/collectors">Explore collector tools</Link></div></footer>
