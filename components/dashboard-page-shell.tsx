...
export async function DashboardPageShell({ title, eyebrow, children }: { title: string; eyebrow?: string; children: ReactNode }) {
  ...
  return <main className="fd-dashboard fd-collector-dashboard">
    ...
    <style>{`
      ...
      .fd-dashboard-atmosphere i{position:absolute;z-index:2;width:46vw;height:1px;right:-7vw;background:linear-gradient(90deg,transparent,rgba(88,232,255,.12),rgba(157,109,255,.2),transparent);transform:rotate(-18deg)}
      .fd-dashboard-atmosphere i:nth-child(1){top:18%}.fd-dashboard-atmosphere i:nth-child(2){top:48%;right:-2vw}.fd-dashboard-atmosphere i:nth-child(3){top:75%;right:-13vw}.fd-dashboard-atmosphere span{position:absolute;z-index:2;right:8%;top:15%;width:180px;height:250px;border:1px solid rgba(157,109,255,.05);border-radius:18px;transform:rotate(13deg);box-shadow:-34px 26px 0 -1px rgba(88,232,255,.025),-68px 52px 0 -1px rgba(157,109,255,.025)}
      ...
      .fd-collector-dashboard .fd-dashboard-sidebar nav,.fd-collector-dashboard .fd-dashboard-sidebar nav>div{min-width:0!important;width:100%!important}
      .fd-collector-dashboard .fd-dashboard-sidebar nav a{box-sizing:border-box!important;width:100%!important;min-width:0!important;max-width:100%!important;display:flex!important;align-items:center!important;white-space:nowrap!important;overflow:hidden!important}
      .fd-collector-dashboard .fd-dashboard-sidebar nav a span{flex:0 0 auto!important}.fd-collector-dashboard .fd-dashboard-sidebar nav a i{flex:0 0 auto!important}
      .fd-collector-dashboard .fd-dashboard-main{min-width:0!important;width:100%!important;max-width:100%!important;overflow:hidden!important}
      .fd-collector-dashboard .fd-dashboard-brand small{color:#817a89;letter-spacing:.08em}.fd-dashboard-content-frame{position:relative;min-width:0}.fd-dashboard-content-frame:before{content:"";position:absolute;z-index:-1;left:0;right:0;top:-18px;height:180px;border-radius:28px;background:linear-gradient(110deg,rgba(157,109,255,.04),transparent 35%,rgba(88,232,255,.028));pointer-events:none}
      ...
      .fd-collector-dashboard .fd-dash-card{border-color:rgba(255,255,255,.085);background:radial-gradient(circle at 100% 0%,rgba(157,109,255,.04),transparent 28%),linear-gradient(145deg,rgba(16,15,24,.9),rgba(9,9,14,.92));box-shadow:inset 0 1px rgba(255,255,255,.025),0 18px 55px rgba(0,0,0,.13)}
