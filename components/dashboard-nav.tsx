...
const fateNetwork: readonly NavItem[] = [
  ["⌘", "Fate Network", "/dashboard/network", "Open the connected Fate Network overview for buying, watching, trading, local discovery and stores."],
  ...
  ["⇄", "Fate Trader", "/dashboard/trader", "List a card you have, tell FateDrop what you want, and find collector-to-collector trade opportunities."],
  ["⌖", "Local Radar", "/dashboard/local-radar", "See local stores, events and verified physical intelligence around you."],
  ["▦", "Stores", "/dashboard/stores", "Browse online and physical retailers across the Fate Network."],
];
