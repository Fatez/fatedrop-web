...
test("Web validates descriptive Local Radar copy and accepts unresolved chain scope without confirmed branch stock", () => {
  ...
  assert.doesNotMatch(route, /branchCount < 1 \|\| branchCount > 100/);
});
