...
test("Alerts read canonical signal truth from the public Cloud contract", () => {
  assert.match(canonicalAlerts, /getLiveCloudSignals/);
...
test("Cloud signal client rejects unexpected source or contract drift", () => {
