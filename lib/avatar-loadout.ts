...
export const AVATAR_OPTION_LABELS = {
  base: { scout: "KAEL", runner: "KAEL · Legacy Profile", warden: "NYRA" },
  ...
  accessory: { none: "No Accessory", chain: "Signal Chain", "card-charm": "Fate Shard Charm", "signal-pin": "Signal Pin", crossbody: "Collector Crossbody" },
  gear: { scanner: "Signal Scanner", binder: "Binder", "slab-case": "Slab Case", none: "No Gear" },
  companion: { "radar-drone": "VØX", "signal-orb": "VØX · Orbit", "mini-beacon": "VØX · Beacon", none: "Solo" },
