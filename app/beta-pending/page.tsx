  ...
  return <SiteShell>
    <main className="beta-pending-page section-shell">
      <section className="beta-pending-card">
        ...
        <p className="lead">
          {revoked
            ? "Your account still exists, but closed-beta access is not currently active."
            : "Your account and sign-in are ready. Access is waiting for Owner approval; once approved, the same account unlocks the FateDrop Web dashboard and mobile App."}
        </p>
        <div className="beta-identity">
          <span><small>EMAIL</small><strong>{snapshot.account.email}</strong></span>
