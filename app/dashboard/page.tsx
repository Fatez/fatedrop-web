...
export default async function DashboardPage() {
  ...
  return <DashboardPageShell title={`Dashboard · ${snapshot.account.displayName}`} eyebrow="COLLECTOR WORKSPACE">
    ...
    <style>{`
      .fd-reference-home{display:grid;gap:10px;max-width:1600px;margin:0 auto}.fd-ref-card{position:relative;min-width:0;overflow:hidden;border:1px solid rgba(221,203,188,.085);border-radius:11px;background:linear-gradient(145deg,#0e1216,#0a0d11 72%);box-shadow:inset 0 1px rgba(255,255,255,.018)}.fd-overview-card{padding:22px 22px 20px}.fd-ref-card-head{display:flex;align-items:flex-start;justify-content:space-between;gap:18px}.fd-ref-card-head h1,.fd-ref-card-head h2{margin:0;color:#eee5dd;font-family:Inter,ui-sans-serif,system-ui,sans-serif;font-size:17px;font-weight:700;letter-spacing:-.02em}.fd-ref-card-head h1{font-size:19px}.fd-ref-card-head p{margin:6px 0 0;color:#9a9297;font-size:12px;line-height:1.55}.fd-ref-card-head>a{color:#b884df;font-size:11px;font-weight:750;text-decoration:none}.fd-ref-card-head>a span,.fd-card-link span{margin-left:6px}.fd-ref-card-head.compact{padding:18px 18px 12px}.fd-lifecycle-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:14px;margin-top:18px}.fd-lifecycle-card{position:relative;min-height:326px;padding:17px;overflow:hidden;border:1px solid rgba(221,203,188,.07);border-radius:9px;background:linear-gradient(145deg,#101419,#0b0f13)}.fd-lifecycle-card>div:first-child{display:grid;gap:4px}.fd-lifecycle-card small{font-size:12px;font-weight:750}.fd-lifecycle-card>div:first-child span{color:#9a9398;font-size:10.5px;line-height:1.4}.fd-lifecycle-window{position:absolute;right:14px;top:16px;color:#8f878d;font-size:9px;font-style:normal;font-weight:850;letter-spacing:.08em;text-transform:uppercase}.fd-lifecycle-value{position:relative;z-index:2;margin-top:20px;display:flex;align-items:center;justify-content:space-between}.fd-lifecycle-value strong{font-family:Georgia,serif;font-size:36px;font-weight:500}.fd-lifecycle-value i{width:40px;height:40px;border:1px solid currentColor;border-radius:50%;opacity:.45;box-shadow:0 0 18px currentColor}.fd-alert-chart-head{display:flex;align-items:center;justify-content:space-between;gap:10px;margin-top:16px;color:#91898f;font-size:9px;font-weight:850;letter-spacing:.08em}.fd-alert-chart-head b{color:#b8afb5;font-size:10px;letter-spacing:0}.fd-alert-chart{margin-top:7px}.fd-lifecycle-card svg{display:block;width:100%;height:68px;overflow:visible}.fd-lifecycle-card svg path{fill:none;stroke:currentColor;stroke-width:1.6;vector-effect:non-scaling-stroke;opacity:.82}.fd-lifecycle-card svg circle{fill:currentColor;stroke:#0c1014;stroke-width:.8;vector-effect:non-scaling-stroke}.fd-lifecycle-card svg .fd-zero-baseline{stroke:rgba(183,174,179,.22);stroke-width:.65;vector-effect:non-scaling-stroke}.fd-alert-axis{display:flex;justify-content:space-between;margin-top:1px;color:#898288;font-size:9px;font-weight:700}.fd-lifecycle-days{display:grid;grid-template-columns:repeat(7,minmax(0,1fr));gap:4px;margin-top:7px}.fd-lifecycle-days span{display:grid;gap:3px;min-width:0;text-align:center}.fd-lifecycle-days small{overflow:hidden;color:#827a81;font-size:9px;font-weight:700;white-space:nowrap}.fd-lifecycle-days b{color:#c7bdc3;font-size:10px;font-weight:700}.fd-detection-context{margin:11px 0 0;color:#91898f;font-size:10px;line-height:1.45}.fd-delivery-health{display:grid;grid-template-columns:.8fr 1.35fr 1fr;gap:7px;margin-top:11px}.fd-delivery-health span{display:grid;gap:4px;padding:8px 9px;border:1px solid rgba(221,203,188,.055);border-radius:6px;background:rgba(255,255,255,.012)}.fd-delivery-health small{color:#8d858b;font-size:8.5px;font-weight:850;letter-spacing:.06em}.fd-delivery-health b{color:#c9bfc5;font-size:12px}.fd-delivery-health span.issue{border-color:rgba(179,78,86,.18)}.fd-delivery-health span.issue b{color:#b65b62}.fd-chart-unavailable{display:grid;gap:3px;min-height:86px;margin-top:10px;padding:12px 10px;align-content:center;border:1px dashed rgba(221,203,188,.08);border-radius:7px;background:rgba(255,255,255,.01)}.fd-chart-unavailable strong{color:#aaa1a7;font-size:11px}.fd-chart-unavailable span,.fd-delivery-unavailable{color:#8d858b;font-size:10px;line-height:1.45}.fd-delivery-unavailable{margin-top:8px}.fd-lifecycle-card.whisper{color:#9f64dc}.fd-lifecycle-card.echo{color:#8c66c5}.fd-lifecycle-card.manifested{color:#85a876}.fd-lifecycle-card.vanished{color:#b34e56}
      .fd-reference-grid{display:grid;grid-template-columns:1.05fr 1.05fr .82fr 1.18fr;gap:12px;align-items:stretch}.fd-recent-signals,.fd-true-price-card,.fd-fatefind-card,.fd-network-pulse-card{min-height:390px}.fd-ref-list{display:grid;padding:0 16px}.fd-signal-row{min-height:66px;padding:10px 4px;display:grid;grid-template-columns:38px minmax(0,1fr) auto;gap:9px;align-items:center;border-top:1px solid rgba(221,203,188,.055)}.fd-signal-row:first-child{border-top:0}.fd-mini-thumb{width:42px;height:42px;display:grid;place-items:center;border:1px solid rgba(158,113,194,.18);border-radius:7px;background:radial-gradient(circle at 50% 35%,rgba(139,77,190,.18),transparent 55%),#13161b;color:#ab83c7;font-family:Georgia,serif;font-size:12px}.fd-mini-thumb.manifested{color:#89aa7a;border-color:rgba(133,168,118,.18)}.fd-mini-thumb.vanished{color:#bb5a61;border-color:rgba(179,78,86,.2)}.fd-mini-thumb.echo{color:#9871cd}.fd-signal-row>div{display:grid;gap:3px;min-width:0}.fd-signal-row>div small{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#938b90;font-size:10px}.fd-signal-row>div strong{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12px}.fd-signal-row aside{display:grid;justify-items:end;gap:4px}.fd-signal-row aside b{padding:5px 7px;border-radius:999px;background:rgba(158,102,205,.08);color:#b68bd6;font-size:9px;font-weight:900;text-transform:uppercase}.fd-signal-row aside b.manifested{color:#7fa272;background:rgba(127,162,114,.08)}.fd-signal-row aside b.vanished{color:#b3585f;background:rgba(179,88,95,.08)}.fd-signal-row aside small{color:#8a8288;font-size:9px}.fd-card-link{position:absolute;left:18px;bottom:15px;color:#b77fe0;font-size:10.5px;font-weight:750;text-decoration:none}.fd-ref-empty{padding:20px 18px;display:grid;gap:8px;color:#938b90}.fd-ref-empty strong{color:#d1c7c2;font-size:12px}.fd-ref-empty span{font-size:10.5px;line-height:1.6}.fd-ref-empty.tall{min-height:205px;align-content:center}
      .fd-price-table{padding:2px 14px 42px}.fd-price-head,.fd-price-row{display:grid;grid-template-columns:minmax(0,1fr) 95px 70px;gap:8px;align-items:center}.fd-price-head{padding:12px 7px 9px;color:#8c8489;font-size:10px}.fd-price-row{min-height:52px;padding:0 7px;border-top:1px solid rgba(221,203,188,.055)}.fd-price-row strong{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#d1c7c2;font-size:11px}.fd-price-row b{color:#e8dfd8;font-size:12px}.fd-price-row small{color:#8b8388;font-size:9.5px;text-align:right}.fd-price-table>p{margin:13px 7px 0;color:#8f878d;font-size:10px;line-height:1.55}.fd-fatefind-list{display:grid;padding:2px 12px 42px}.fd-fatefind-list>div:not(.fd-ref-empty){min-height:60px;padding:9px 10px;display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8px;align-items:center;border:1px solid rgba(221,203,188,.055);border-radius:8px;background:#0f1317;margin-top:7px}.fd-fatefind-list span{display:grid;gap:4px;min-width:0}.fd-fatefind-list strong{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12px}.fd-fatefind-list small{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#928a8f;font-size:10px}.fd-fatefind-list b{min-width:25px;height:25px;padding:0 7px;display:grid;place-items:center;border-radius:9px;background:rgba(129,74,174,.16);color:#cfabe8;font-size:10px}.fd-network-pulse-card{padding-bottom:35px}.fd-network-pulse-card>.fd-pulse-layout{padding:0 8px}
      .fd-recent-drops,.fd-retailer-card{min-height:310px}.fd-drop-grid{padding:0 12px 40px;display:grid;grid-template-columns:repeat(4,1fr);gap:7px}.fd-drop-mini{min-width:0;display:grid;gap:4px}.fd-drop-art{position:relative;aspect-ratio:.8/1;display:grid;place-items:center;overflow:hidden;border:1px solid rgba(221,203,188,.08);border-radius:7px;background:radial-gradient(circle at 50% 25%,rgba(141,86,178,.18),transparent 44%),linear-gradient(155deg,#17181b,#0c1014);color:#c1a4d2;font-family:Georgia,serif;font-size:13px}.fd-drop-art i{position:absolute;width:54%;height:54%;border:1px solid rgba(190,151,213,.13);transform:rotate(45deg)}.fd-drop-mini strong{overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;color:#d3cac5;font-size:10px;line-height:1.4}.fd-drop-mini small{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#8e868b;font-size:9px}.fd-drop-mini>b{color:#e5dcd6;font-size:10px}.fd-retailer-list{display:grid;padding:0 12px 40px}.fd-retailer-list>div:not(.fd-ref-empty){min-height:52px;display:grid;grid-template-columns:26px minmax(0,1fr) auto auto;gap:8px;align-items:center;border-top:1px solid rgba(221,203,188,.055)}.fd-retailer-list>div:first-child{border-top:0}.fd-store-mark{width:28px;height:28px;display:grid;place-items:center;border-radius:6px;background:rgba(150,96,184,.09);color:#b78fd0;font-size:12px}.fd-retailer-list strong{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:11px}.fd-retailer-list small{color:#8e868b;font-size:9.5px}.fd-retailer-list b{color:#b09682;font-size:9.5px;font-weight:650}
      .fd-koru-dashboard-card{position:relative;grid-column:3 / 5;min-height:270px;overflow:hidden;border:1px solid rgba(181,151,128,.16);border-radius:11px;background:#090d11 url('/assets/dashboard/koru-network-guide.png') center center/cover no-repeat;box-shadow:inset 0 1px rgba(255,255,255,.02)}.fd-koru-action{position:absolute;z-index:2;left:16px;top:16px;padding:10px 12px;border:1px solid rgba(215,190,166,.18);border-radius:8px;background:rgba(6,10,14,.66);backdrop-filter:blur(10px);color:#e0c9b2;font-size:10px;font-weight:800;text-decoration:none;letter-spacing:.02em;transition:.16s ease}.fd-koru-action:hover{border-color:rgba(215,190,166,.32);background:rgba(6,10,14,.82);transform:translateY(-1px)}.fd-koru-action span{margin-left:5px}
