...
function searchHref(input: { q: string; stockOnly: boolean; sort?: string; category?: string; maxPrice?: string; cursor?: string }) {
  const params = new URLSearchParams({ q: input.q, stock: input.stockOnly ? "in" : "all", sort: input.sort ?? "recent" });
...
export default async function DashboardSearchPage({ searchParams }: { searchParams: Promise<{ q?: string; stock?: string; sort?: string; category?: string; maxPrice?: string; cursor?: string }> }) {
  ...
  return (
    <DashboardPageShell title="Search" eyebrow="FIND · COMPARE · BUY">
      ...
      <style>{`
        .fd-search-page{display:grid;gap:22px}.fd-search-hero,.fd-search-results{padding:28px}.fd-network-search-form{display:grid;grid-template-columns:minmax(260px,1.4fr) 130px 130px 120px 130px auto;gap:10px;align-items:end;margin-top:24px}.fd-network-search-form>label{display:grid;gap:6px}.fd-network-search-form>label>span{color:#696370;font-size:7px;font-weight:900;letter-spacing:.12em}.fd-network-search-form select,.fd-network-search-form>label>input{height:46px;padding:0 11px;border:1px solid rgba(255,255,255,.09);border-radius:12px;background:#0b0a10;color:#d9d4df}.fd-network-search-form button{height:46px;padding:0 17px;border:1px solid rgba(104,232,251,.24);border-radius:12px;background:linear-gradient(135deg,rgba(104,232,251,.1),rgba(157,109,255,.12));color:#fff;font-size:9px;font-weight:900;letter-spacing:.08em}.fd-dashboard-search{height:46px;margin:0!important}.fd-search-groups{display:grid;gap:15px;margin-top:18px}.fd-search-group{overflow:hidden;border:1px solid rgba(255,255,255,.075);border-radius:18px;background:#0b0a10}.fd-search-group>header{display:flex;justify-content:space-between;gap:20px;padding:18px 20px;background:radial-gradient(circle at 100% 0%,rgba(157,109,255,.06),transparent 30%)}.fd-search-group>header small{display:block;color:#73e9fb;font-size:7px;font-weight:900;letter-spacing:.1em}.fd-search-group>header h2{margin:5px 0 0;font-size:18px}.fd-search-group>header>div:last-child{text-align:right}.fd-search-group>header>div:last-child strong{display:block;margin-top:4px;font-size:15px}.fd-search-offers{display:grid;gap:1px;background:#19161e}.fd-search-offer{display:grid;grid-template-columns:minmax(150px,.8fr) minmax(350px,1.2fr);gap:12px;padding:14px 20px;background:#0b0a10}.fd-search-offer>div:first-child small{display:block;color:#71e8ae;font-size:6px;font-weight:900;letter-spacing:.1em}.fd-search-offer>div:first-child strong{display:block;margin:4px 0;font-size:12px}.fd-search-offer>div:first-child span{color:#6f6975;font-size:8px}.fd-search-offer-price{display:grid;grid-template-columns:repeat(4,1fr);gap:6px}.fd-search-offer-price span{padding:8px;border:1px solid rgba(255,255,255,.05);border-radius:9px;background:rgba(0,0,0,.13)}.fd-search-offer-price small{display:block;color:#625c69;font-size:6px;font-weight:900;letter-spacing:.08em}.fd-search-offer-price b{font-size:9px}.fd-search-offer-foot{grid-column:1/-1;display:flex;align-items:center;justify-content:space-between;gap:12px}.fd-search-offer-foot>span{color:#817a88;font-size:8px}.fd-search-offer-foot>a{color:#cdb5ff;font-size:8px;font-weight:900}.fd-search-group>footer{display:flex;gap:14px;padding:12px 20px;border-top:1px solid rgba(255,255,255,.055)}.fd-search-group>footer a{color:#9eefff;font-size:8px;font-weight:900;text-decoration:none}.fd-search-pagination{display:flex;justify-content:space-between;gap:15px;margin-top:18px}.fd-search-pagination a{padding:10px 13px;border:1px solid rgba(157,109,255,.18);border-radius:9px;color:#cdb5ff;font-size:8px;font-weight:900;text-decoration:none}@media(max-width:1200px){.fd-network-search-form{grid-template-columns:1fr 1fr 1fr}.fd-dashboard-search{grid-column:1/-1}.fd-network-search-form button{align-self:end}}@media(max-width:800px){.fd-network-search-form{grid-template-columns:1fr 1fr}.fd-search-offer{grid-template-columns:1fr}.fd-search-offer-foot{grid-column:auto}.fd-search-offer-price{grid-template-columns:1fr 1fr}.fd-search-group>header{flex-direction:column}.fd-search-group>header>div:last-child{text-align:left}}@media(max-width:520px){.fd-network-search-form{grid-template-columns:1fr}.fd-dashboard-search{grid-column:auto}.fd-search-offer-price{grid-template-columns:1fr}.fd-search-group>footer{flex-direction:column}}
      `}</style>
    </DashboardPageShell>
  );
}