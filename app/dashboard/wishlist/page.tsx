  ...
  return <DashboardPageShell title="Wishlist" eyebrow="SAVE WHAT YOU WANT">
    <div className="fd-wishlist-page">
      <section className="fd-dash-card fd-wishlist-hero">
        ...
        <h1>Wishlist means “I want this.”<br/><em>FateMatch means “let me know when this is in stock.”</em></h1>
        <p>Save a product regardless of retailer or stock state. Use FateFind when you want the best live value now; use FateMatch when you want FateDrop and your companion to keep watching for a qualifying offer.</p>
