  ...
  return <DashboardPageShell title="Wishlist" eyebrow="SAVE WHAT YOU WANT">
    <div className="fd-wishlist-page">
      <section className="fd-dash-card fd-wishlist-hero">
        ...
        <p>Save a product here regardless of retailer or stock state. When you want conditions such as a maximum delivered price, RRP premium or local radius, turn that intent into a FateFind instead.</p>
        <div><Link href="/dashboard/search">Search products →</Link><Link href="/dashboard/watchlist">Open FateFind →</Link></div>
      </section>
