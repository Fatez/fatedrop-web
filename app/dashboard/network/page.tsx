...
export const metadata: Metadata = {
  ...
  description: "The connected FateDrop network for value finding, monitoring, trading, local intelligence and retailer discovery.",
...
const tools: readonly NetworkTool[] = [
  {
    ...
    title: "FateFind",
    description: "Find the strongest qualifying place to buy using canonical product identity, RRP/reference and True Price intelligence.",
  ...
  },
  {
    eyebrow: "MONITORING",
    title: "FateMatch",
    description: "Create buying conditions and let FateDrop monitor until a qualifying opportunity becomes true.",
    href: "/dashboard/watchlist",
    action: "Open FateMatch",
  },
  {
    eyebrow: "COLLECTOR TRADING",
    title: "Fate Trader",
    description: "Record what you have and what you want, then discover compatible collector-to-collector trade opportunities.",
  ...
  },
  {
    ...
    title: "Local Radar",
    description: "Find nearby physical retailers and see what stock may be arriving or is genuinely confirmed at an exact branch.",
    href: "/dashboard/local-radar",
    action: "Open Local Radar",
  },
  {
    eyebrow: "RETAILER DISCOVERY",
    title: "Retailers",
    description: "Discover major, specialist and independent retailers across Fate Network without changing organic FateFind ranking.",
...
export default async function DashboardNetworkPage() {
  ...
  return <DashboardPageShell title="Fate Network" eyebrow="ONE NETWORK · CONNECTED COLLECTOR TOOLS">
    <div className="fd-network-hub">
      <section className="fd-network-hero">
        <span>FATE NETWORK</span>
        <h1>One connected network. Different tools for different collector intentions.</h1>
        <p><strong>FateFind</strong> finds value. <strong>FateMatch</strong> monitors buying conditions. <strong>Fate Trader</strong> connects collector trade intentions. <strong>Local Radar</strong> handles physical/local intelligence. <strong>Retailers</strong> helps collectors discover the retail ecosystem. Search and Wishlist remain universal utilities.</p>
      </section>
      ...
      <section className="fd-network-live">
        <div className="fd-network-live-copy">
          ...
          <h2>What is happening across FateDrop right now?</h2>
          <p>Network Pulse remains the macro monitoring-health view. It is separate from the collector tools above and does not manufacture activity when canonical network data is unavailable.</p>
        </div>
