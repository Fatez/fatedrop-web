  ...
  return <DashboardPageShell title="FateDrop Companion" eyebrow="ACCOUNT · LIVE COMPANION">
    <div className="fd-avatar-page">
      <section className="fd-avatar-hero">
        <div><span>FATEDROP // YOUR NETWORK COMPANION</span><h1>Meet the collector<br/><em>that hunts with you.</em></h1><p>Your FateDrop Companion is a live 3D presence across the collector dashboard. Preview the character and Signal Droid reactions, then shape the account loadout that follows your FateDrop ID across web and app surfaces.</p></div>
