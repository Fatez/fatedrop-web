  ...
  return (
    <DashboardPageShell title="My FateDrop ID" eyebrow="COLLECTOR IDENTITY">
      <div className="fd-dashboard-grid">
        ...
        <section className="fd-dash-card fd-profile-avatar-card"><div className="fd-dash-card-head"><span>YOUR FATEDROP AVATAR</span><small>Dashboard · FateMatch · App</small></div><div className="fd-profile-avatar-layout"><AvatarPreview loadout={avatar.loadout} mood="watching" compact label={`${snapshot.account.displayName}'s companion`}/><div><h2>Your network companion.</h2><p>Build an original FateDrop avatar with TCG preference styling, gear, aura and a companion. The same saved loadout is designed to follow your FateDrop ID across every interface.</p><Link className="fd-dashboard-wide-button" href="/dashboard/avatar">Design my avatar →</Link></div></div></section>
      </div>
