  ...
  return (
    <SiteShell>
      ...
      <section className="subscription-teaser section-shell">
        ...
        <div className="subscription-summary"><article><span>Collectors</span><strong>£0 → £14.99</strong><p>Free identity and discovery; Plus begins at £4.99/month and Pro at £14.99/month. Final higher-tier feature gates will be reviewed before launch.</p></article><article><span>Connected access</span><strong>WEB → APP → DISCORD</strong><p>One membership state designed to follow the collector across the FateDrop network.</p></article><small>Stripe sandbox plans are configured; production billing activates only when live credentials and prices are connected.</small></div>
      </section>
