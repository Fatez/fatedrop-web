  ...
  return (
    <SiteShell>
      ...
      <section className="collector-subscription section-shell">
        ...
        <div className="subscription-summary"><article><span>FateDrop Plus</span><strong>£4.99 / month</strong><p>Product alerts, lifecycle notifications, Universal Wishlist, FateFind, True Price and Local Radar alerts.</p></article><article><span>FateDrop Pro</span><strong>£7.99 / month</strong><p>Advanced lifecycle, collection, basket, event and future multi-TCG tools as infrastructure supports them.</p></article><small>14-day collector trial flow prepared · Stripe connection required for live checkout</small><Link className="button button-secondary" href="/subscriptions#collectors">Compare collector plans <span>↗</span></Link></div>
      </section>
