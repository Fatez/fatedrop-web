    ...
    <SiteShell>
      ...
      <section className="account-grid section-shell">
        <article className="account-panel membership-panel">
          ...
          <p>{premium ? "Premium entitlement is active for this FateDrop ID. The website consumes this state now; app and Discord clients should use the same entitlement only as their integrations are individually connected and verified." : "Your FateDrop ID is active on the free network. Upgrade when you want deeper stock intelligence and Premium community access where those integrations are enabled."}</p>
